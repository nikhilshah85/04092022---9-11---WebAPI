...
using shoppingWebAPI_EF.Models.EF;
...
namespace shoppingWebAPI_EF.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        //public CustomersController(shoppingAPIDBContext context)
        //{
        //    _context = context;
        //}
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
          if (_context.Customers == null)
          {
              return Problem("Entity set 'shoppingAPIDBContext.Customers'  is null.");
          }
